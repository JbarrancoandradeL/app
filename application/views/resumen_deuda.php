                    ...
                    <div id="pricing_table_example1" class="row">
                        <div class="col-sm-12">
                            <div class="pricing-table col-sm-3 col-xs-12">
                                <h3>Resultados actuales<h1 currency>$ 45000000</h1>
                                </h3>
                            ...
                            <div class="pricing-table col-sm-3 col-xs-12">
                                <h3>Simulador <h1 currency>$ 45000000</h1>
                                </h3>
                                <a href="" class="btn btn-green">
                                    Mas Detalles
                                </a>
                            ...
                            <div class="pricing-table col-sm-3 col-xs-12">
                                <h3>Ahorro <h1 currency>$ 45000000</h1>
                                </h3>
...
function show_datos(argument) {
    ...
    $.ajax({
        ...
        success: function(result) {
            ...
            $('input:radio[name=add_pais][value=' + datos_usuario[0]['pais'] + ']').prop('checked',
                'checked');
    ...
    if (id_dtto != "") {
        for (x in city_data) {
            if (parseInt(city_data[x]['codigo_dtto']) == id_dtto) {
                code_select += '<option value="' + city_data[x]['id_municipio'] + '"> ' + city_data[x]['municipio'] +
                    ' </option>';
